              ...
              <div className="h-[250px] flex flex-col items-center justify-center text-slate-400 gap-2 border-2 border-dashed border-slate-200 rounded-3xl bg-slate-50/50">
                ...
                <button 
                  onClick={async () => {
                    ...
                    const testMembers = [
                      { email: 'abinet@example.com', full_name: 'Abinet Tesfaye', loyalty_tier: 'Trekker', points_balance: 1200, average_spend: 450.00, onboarding_completed: true },
                      { email: 'blen@example.com', full_name: 'Blen Kebede', loyalty_tier: 'Pinnacle', points_balance: 5500, average_spend: 1200.00, onboarding_completed: true },
                      { email: 'genet@example.com', full_name: 'Genet Wolde', loyalty_tier: 'Pinnacle', points_balance: 10000, average_spend: 1500.00, onboarding_completed: true }
                    ];
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
            ...
            {analysis.customerSegments && analysis.customerSegments.length > 0 ? (
              ...
              <div className="h-full flex items-center justify-center text-slate-300">
                <PieChartIcon size={48} className="opacity-10" />
              </div>
            )}
          </div>
        </div>
